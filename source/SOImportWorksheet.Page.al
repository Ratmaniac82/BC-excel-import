page 50102 "PPI SO Import Worksheet"
{
    AutoSplitKey = true;
    ...
    PageType = Worksheet;
    SaveValues = true;
    SourceTable = "PPI SO Import Buffer";
    ...
    var
        ...
        BatchIsEmptyMsg: Label 'Batch name is empty';
    ...
    var
        SOImportBuffer: Record "PPI SO Import Buffer";
        RowNo: Integer;
        ColNo: Integer;
        LineNo: Integer;
        MaxRowNo: Integer;
